...
<style>
    body{
        overflow-x: hidden;
        background-image: url("https://thumbs.dreamstime.com/b/technology-fingerprint-scan-provides-security-digital-transformation-change-management-new-big-data-business-process-strategy-183410613.jpg");
...
<div class="row">
    <div class="col-sm-12">
        <div class="main-content">
            <div class="header">
                <h3 style="text-align: center;color: red;"><strong>Change Your Password</strong></h3><hr>
            </div>
            <div class="l_pass">
                <form action="" method="post">
                    ...
                    <center><button id="signup" class="btn btn-info" name="change">Change Password</button></center>
                </form>
            </div>
        </div>
    </div>
