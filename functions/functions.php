...
$con = mysqli_connect("localhost","root","password","social_network") or die("Connection was not established");
		...
		if($p_id != $post_id){
			...
			if(isset($_POST['reply'])){
				...
				if($comment == ""){
					...
					(post_id,user_id,comment,comment_author,date) values('$post_id','$user_id','$comment',
					'$user_com_name',NOW())";
...
function results(){
	...
	$get_posts = "select * from posts where posts_content like '%$search_query%' OR upload_image like '%$search_query%'";
