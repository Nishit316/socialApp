...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$descuser = htmlentities(mysqli_real_escape_string($con,$_POST['desc_user']));
		$relation = htmlentities(mysqli_real_escape_string($con,$_POST['relation']));
		...
		// $profile_pic = "58353-16177781910587-800.avif";
		$status = "verified";
		$posts = "no";
		...
		values('$first_name','$last_name','$username','$descuser','$relation','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
