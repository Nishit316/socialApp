...
<style>
  body{
    background-image: url("https://wallpaperaccess.com/full/121335.jpg");
           ...
           if(isset($_GET['u_id'])){
             ...
             if($u_id == "new"){
               echo '
                     ...
                     <form>
                         <center><h3 style="color: red;">Select Someone to start conversation</h3></center>
            ...
            <div class='row'>
              ...
              <center>
                <div style='background-color: #e6e6e6;' class='col-sm-9'>
                    ...
                    <ul class='list-group'>
                       <li class='list-froup-item' title='Username'><strong>$f_name $l_name</strong></li>
                       <li class='list-froup-item' title='User Status'><strong style='color:grey;'>$describe_user</strong></li>
                       <li class='list-froup-item' title='Gender'>$gender</li>
                       <li class='list-froup-item' title='Country'>$user_country</li>
                       <li class='list-froup-item' title='User Registration Date'>$register_date</li>
                    </ul>
                </div>
              </center>
                <div class='col-sm-1'>
